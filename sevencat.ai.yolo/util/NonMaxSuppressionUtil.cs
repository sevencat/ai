...
{
	public static ImmutableArray<RawBoundingBox> Apply(Span<RawBoundingBox> boxes, float iouThreshold)
	{
		if (boxes.Length == 0)
		{
			return [];
	...
	protected static float CalculateIoU(RawBoundingBox box1, RawBoundingBox box2)
	{
